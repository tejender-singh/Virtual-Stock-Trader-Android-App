 ...
 */
public class IoHandler extends DefaultHandler{
//	private String url = "http://www.indiatvnews.com/rssfeed/india.xml";
	private String url = "http://www.outlookindia.com/oirss.aspx?source=web&id=0";
...
//			System.out.println("End Element :" + qName);
			...
			if(qName.equalsIgnoreCase("item"))
			{
				...
				inItem=false;
				try {
					urlnew = description.substring((description.indexOf("src=") + 5), (description.indexOf(".jpg") + 4));
				}catch (Exception e)
				{
					urlnew="";
				}
