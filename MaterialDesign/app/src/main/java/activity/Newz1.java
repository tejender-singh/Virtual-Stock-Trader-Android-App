...
public class Newz1 extends Activity {
	...
	class myrun implements Runnable
	{
		...
		public void run() {
			...
			final IoHandler1 handler=new IoHandler1();
	        handler.processFeed();
	        naya=handler.getVids();
	        
		    Newz1.this.runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							try
							{
								adap=new ListAdap(Newz1.this, vids);
								lv.setAdapter(adap);
								lv.setOnItemClickListener(new OnItemClickListener() {
									...
									public void onItemClick(
										...
										Intent in=new Intent(Newz1.this,Detail.class);
										in.putExtra("link", v.getlink());
										Toast.makeText(Newz1.this, v.gettitle(),Toast.LENGTH_LONG).show();
										startActivity(in);
									}
								});
