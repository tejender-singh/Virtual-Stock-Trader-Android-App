...
public class Newz3 extends Activity {
	...
	class myrun implements Runnable
	{
		...
		public void run() {
			...
			final IoHandler3 handler=new IoHandler3();
	        handler.processFeed();
	        naya=handler.getVids();
	        
		    Newz3.this.runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							try
							{
								adap=new ListAdap1(Newz3.this, vids);
								lv.setAdapter(adap);
								lv.setOnItemClickListener(new OnItemClickListener() {
									...
									public void onItemClick(
										...
										Intent in=new Intent(Newz3.this,Detail.class);
										in.putExtra("link", v.getlink());
										Toast.makeText(Newz3.this, v.gettitle(),Toast.LENGTH_LONG).show();
										startActivity(in);
									}
								});
