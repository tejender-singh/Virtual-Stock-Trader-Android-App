 ...
 */
public class IoHandler3 extends DefaultHandler{
//	private String url = "http://www.indiatvnews.com/rssfeed/india.xml";
	private String url = "http://www.forbes.com/markets/feed/";
...
//			System.out.println("End Element :" + qName);
			...
			if(qName.equalsIgnoreCase("item"))
			{
				...
				vids.add(new Vids(title.toString(),description.toString(),link.toString(),null));
